...
@Injectable()
export class Group1ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group1/test";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class Group3ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group3/test";
        url_ = url_.replace(/[?&]$/, "");
...
@Injectable()
export class Group5ServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     */
    test(): Observable<string> {
        let url_ = this.baseUrl + "/api/Group5/test";
        url_ = url_.replace(/[?&]$/, "");
